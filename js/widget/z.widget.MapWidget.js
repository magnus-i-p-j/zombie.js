...
z.widget.MapWidget.prototype.template = '' + '<div data-bind="foreach: visibleTiles" class="map_widget">' + '<div data-bind="attr: { class: terrain() + isSelected() + \' tile\' }, style: { top: $parent.computeScreenPositionY($data), left: $parent.computeScreenPositionX($data) }">' + '<div class="center_text">' + '(<span data-bind="text: x"></span>, <span data-bind="text: y"></span>)' + '</div>' + '</div>' + '</div>';
