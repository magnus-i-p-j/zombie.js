...
z.widget.MapWidget.prototype.template = '' + '<div data-bind="foreach: visibleTiles" class="map_widget">' + '<div data-bind="attr: { class: terrain() + \' tile\' }">' + '<div class="center_text">' + '(<span data-bind="text: x"></span>, <span data-bind="text: y"></span>)' + '</div>' + '</div>' + '</div>';
