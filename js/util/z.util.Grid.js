...
z.util.Grid.prototype.getAdjacent = function (node) {
    return [this.getNode(node.c - 1, node.r + 1), this.getNode(node.c, node.r + 1),
        this.getNode(node.c + 1, node.r),
        this.getNode(node.c + 1, node.r - 1), this.getNode(node.c, node.r - 1),
        this.getNode(node.c - 1, node.r)];
};
