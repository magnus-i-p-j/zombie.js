TestCase('test Grid', {
  ...
  'test getting adjacent nodes':function () {
    ...
    var exceptedAdjacent = [this.grid.getNode(x - 1, y + 1), this.grid.getNode(x, y + 1), this.grid.getNode(x + 1, y), this.grid.getNode(x + 1, y - 1), this.grid.getNode(x, y - 1), this.grid.getNode(x - 1, y)];
